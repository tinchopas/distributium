...
namespace Distributium\FrontendBundle\Controller\Api;
 ...
 *
 *
 * @author Martin Pascal <mspascal@gmail.com>
 */
class ProductController extends FOSRestController
{
 public function getJsonAction()
 {
        $products = $this->getDoctrine()->getManager()->getRepository("DistributiumBackendBundle:Item")->findAll();
     $data = array(
         "uno" => "primero",
         "dos" => "segundo",
    //... 
